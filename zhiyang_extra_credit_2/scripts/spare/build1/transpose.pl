...
#				}
			...
			# =========================================
			# If this is the last row to be processed...
			#
			# Print the contents of the arrays that
			# contain the number of ONEs found in each
			# column and the index of the most recent
			# found ONE in that column
			if($ipg_row == ($ip_rows-1)) {
				# For each column, determine its # ONEs
				foreach $prm (@num_ones_in_col) {
					#print clp $_," ";
					print clp $prm," ";
				}
				print clp "\n";
